...
Se utilizaran las variables no factorizas y númericas para poder ver estos valores
</p>
...
En el apartado de limpeza de datos hemos detectado un valor atípico en la variable `Fare` mediante el diagrama de caja ,donde podemos ver un valor muy grande que se ha pagado por el billete de de embarcación. Esta cantidad han sido 512.3292 y repetida en tres pasajeros ditintos, por lo tanto miraremos que relación pueden tener estos tres pasajeros. </p>
...
<p ALIGN="justify">
Donde vemos que el porcentaje mayor de supervivencia es en los pasajeros de embarcación C.
...
Con el gráfico anterior podemos ver que se pueden acumular muchas clases en un gráfico, ya hemos analizado la variable Age en funcion de si era adulto o niño, pero en el siguiente gráfico analizaremos en funcion de la edad, utilizando un gráfico parecido al anterior, que nos acumula las proporciones y nos muestra las frequencias.
...
Como podemos ver la frequencia de supervivencia va de más a menos en función va aumentando loa edad, habiendo unos picos y bajones entre ellos, y viendo que al final hubo supervivencia a alta edad.
...
A continuación realizaremos la prueba T student, una de las pruebas más utilizadas en la estadística. Teniendo como hipotesis nula que que las medias de las edades en los grupos son iguales y teniendo como alternativas mayores y menores.
